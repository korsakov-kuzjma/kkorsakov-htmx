...
3. [Фильтры (Hooks)](#фильтры-hooks)
4. [Расширение REST API](#расширение-rest-api)
5. [Добавление новых типов фрагментов](#добавление-новых-типов-фрагментов)
6. [Кастомизация HTMX](#кастомизация-htmx)
7. [Создание собственного компонента](#создание-собственного-компонента)
8. [Шаблоны фрагментов](#шаблоны-фрагментов)
9. [Безопасность](#безопасность)
10. [Примеры расширений](#примеры-расширений)
