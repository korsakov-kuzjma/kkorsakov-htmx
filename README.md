...
- **Документация в админке WordPress**
...
После активации плагина в админке WordPress появится новый пункт меню **HTMX**.

### Страница настроек

Перейдите: **HTMX → Настройки**

Здесь вы можете настроить:

- **Использовать CDN** — загружать HTMX с внешнего сервера (unpkg.com)
- **Принудительная загрузка** — загружать HTMX на всех страницах сайта
- **Включить историю** — поддержка кнопок назад/вперёд в браузере
- **Стиль замены** — способ подмены контента (innerHTML, outerHTML и др.)

### Страница документации

Перейдите: **HTMX → Документация**

Здесь вы найдёте полную документацию по использованию плагина на русском языке.
